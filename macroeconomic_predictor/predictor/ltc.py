...
# Intent of this class: create a Liquid Time-Constant (LTC) cell implemented for an RNN
# Source of structure: https://arxiv.org/pdf/2006.04439.pdf
# GitHub reference for original implementation: https://www.github.com/
...
class LTCCell(tf.keras.layers.AbstractRNNCell):
    def __init__(self, units, ode_steps=6, **kwargs):
        ...
        self.solver = ODESolver.SEMI_IMPLICIT
